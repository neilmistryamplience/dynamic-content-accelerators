        ...
        polygonCallbacks: [
          {
            ...
            callback: function (evt, settings) {
              ...
              if( settings.polygon.selector == "product"){
                ...
                var link = '{SFCC_URL}/s/{SFCC_SITEID}/amp-product-link/' + settings.polygon.target + '.html';
        ...
        hotspotCallbacks: [
          {
            ...
            callback: function (evt, settings) {
              ...
              if( settings.hotspot.selector == "product"){
                // Go to the product URL
                var link = '{SFCC_URL}/s/{SFCC_SITEID}/amp-product-link/' + settings.hotspot.target + '.html';
                window.open(link,"_self");
              } else {
